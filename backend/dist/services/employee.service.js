...
class EmployeeService {
    ...
    async getAll(query) {
        ...
        if (search && search.trim() !== '') {
            ...
            queryBuilder.andWhere('(employee.firstName LIKE :search OR employee.lastName LIKE :search OR employee.email LIKE :search)', { search: searchTerm });
        }
    ...
    async update(id, data) {
        ...
        if (data.hireDate !== undefined)
            employee.hireDate = new Date(data.hireDate);
        if (data.salary !== undefined)
            employee.salary = data.salary;
        if (data.departmentId !== undefined)
            employee.departmentId = data.departmentId || undefined;
        return this.employeeRepository.save(employee);
    }
